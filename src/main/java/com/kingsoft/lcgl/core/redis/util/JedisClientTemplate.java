...
public class JedisClientTemplate {
    private static final Logger log = LoggerFactory.getLogger(JedisClientTemplate.class);
    ...
    public void disconnect() {
        ...
        shardedJedis = jedisDataSource.getRedisClient();
     ...
     * @return
     */
    public String hmset(String key, HashMap<String, String> hash) {
        String result = null;
        ShardedJedis shardedJedis = jedisDataSource.getRedisClient();
        if (shardedJedis == null) {
            return result;
    ...
    public Long timeout(String key, int seconds) {
        Long result = null;
        ShardedJedis shardedJedis = jedisDataSource.getRedisClient();
        if (shardedJedis == null) {
            return result;
